...
import xyz.lilei.cgou.order.dao.OrderItemMapper;
import xyz.lilei.cgou.order.dao.OrderMapper;
import xyz.lilei.cgou.order.pojo.Order;
import xyz.lilei.cgou.order.pojo.OrderItem;
import xyz.lilei.cgou.order.service.CartService;
import xyz.lilei.cgou.order.service.OrderService;
...
public class OrderServiceImpl implements OrderService {
    ...
    public void deleteOrder(String id) {
        ...
        orderItems.forEach(
                o ->{
                    request.put(String.valueOf(o.getSkuId()), o.getNum());
                }
        );
        skuFeign.incrCount(request);
        //删除缓存
