package xyz.lilei.cgou.pay.service.impl;

import com.github.wxpay.sdk.WXPayUtil;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.stereotype.Service;
import xyz.lilei.cgou.common.utils.HttpClient;
import xyz.lilei.cgou.pay.service.WeixinPayService;
...
public class WeixinPayServiceImpl implements WeixinPayService {
    ...
    @Value("${weixin.payUnifiedOrderUrl}")
    ...
    public Map createNative(String out_trade_no, String total_fee){
        try {
            ...
            param.put("mch_id", mchId);                           //商户ID号
            param.put("nonce_str", WXPayUtil.generateNonceStr());   //随机数
            param.put("body", "cgou");                            	//订单描述
            ...
            //2、将参数转成xml字符，并携带签名
            String paramXml = WXPayUtil.generateSignedXml(param, appSecret);

            ///3、执行请求
            HttpClient httpClient = new HttpClient(payUnifiedOrderUrl);
