...
import xyz.lilei.cgou.goods.dao.CategoryMapper;
import xyz.lilei.cgou.goods.dao.SkuMapper;
import xyz.lilei.cgou.goods.dao.SpuMapper;
import xyz.lilei.cgou.goods.pojo.*;
import xyz.lilei.cgou.goods.service.SpuService;
...
public class SpuServiceImpl implements SpuService {
    ...
    public void save(Goods goods) {
        ...
        for (Sku sku : skuList) {
            ...
            StringBuilder title = new StringBuilder(spu.getName());
