...
import xyz.lilei.cgou.goods.dao.SkuMapper;
import xyz.lilei.cgou.goods.pojo.Sku;
import xyz.lilei.cgou.goods.service.SkuService;
...
public class SkuServiceImpl implements SkuService {
    ...
    public void decrCount(String username) {
        //获取购物车数据
        List<OrderItem> orderItems = JSONObject.parseArray(JSONObject.toJSONString(redisTemplate.boundHashOps("Cart_" + username).values()), OrderItem.class);
    ...
    @Override
    public void incrCount(@RequestBody JSONObject request) {
        request.forEach((key, value) -> skuMapper.incrCount(key, (Integer) value));
