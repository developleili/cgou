package xyz.lilei.cgou.fescar.config;
...
import xyz.lilei.cgou.fescar.interceptor.FescarRestInterceptor;
...
/**
 * @ClassName FescarRMRequestFilter
 * @Author lilei
 * @Date 14/07/2020 23:43
 * @Version 1.0
 **/
@Configuration
public class FescarAutoConfiguration {
    ...
    @Bean
    public FescarAutoConfiguration fescarRMRequestFilter(){
        return new FescarAutoConfiguration();
    }
